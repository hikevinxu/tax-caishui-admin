...
<script>
import { qualificateList, qualificateDown, qualificateUp, qualificateSave, qualificateDetail, qualificateDelete,qualificateDecr,qualificateIncr,operateList } from '@/api/qualification'
